...
const Chats = () => {
    ...
    return (
        <div className=''>
            ...
            <div className='h-[13vh] bg-white py-2 fixed md:left-[20vw] md:w-[80vw] w-full flex justify-center items-center'>            <SendMessage socket={socket} receiverId={id} setMessages={setMessages}/> </div>
        </div>
    );
};
