...
const Chats = () => {
    ...
    return (
        <div className=''>
            ...
            <div className='h-[20vh] bg-white fixed md:left-[20vw] md:w-[80vw] w-full flex justify-center items-center pb-[10vh] pt-1'>            <SendMessage socket={socket} receiverId={id} setMessages={setMessages}/> </div>
        </div>
    );
};
